...
gdjs.MenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9463836);
}
}}
}
...
gdjs.MenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9466740);
}
}}
if (gdjs.MenuCode.condition1IsTrue_0.val) {
